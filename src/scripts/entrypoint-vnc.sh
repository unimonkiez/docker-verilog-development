...
if id "default" &>/dev/null; then
    echo "yes 'default' user exists"
else
    echo "No, 'default' does not exist"
...
$SRC/scripts/wm_startup.sh &> $STARTUPDIR/wm_startup.log
